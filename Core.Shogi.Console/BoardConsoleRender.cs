namespace Core.Shogi.Console
{
    internal class BoardConsoleRender : IBoardRender
    {
        ...
        private static void PrintRow(string rowName, string column1, string column2, string column3, string column4, string column5, string column6, string column7, string column8, string column9, BoardState boardState)
        {
            System.Console.WriteLine("-----------------------------------------");
        ...
        private static char GetPieceShortName(string pieceLocation, BoardState boardState)
        {
