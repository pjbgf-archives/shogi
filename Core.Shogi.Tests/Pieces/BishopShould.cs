...
namespace Core.Shogi.Tests.Pieces
{
    ...
    public class BishopShould
    {
        ...
        //[InlineData(Player.Black, "8g", "8f", TestName = "NotMoveForwardAsBlackPlayer")]
        //[InlineData(Player.White, "8c", "8d", TestName = "NotMoveForwardAsWhitePlayer")]
        ...
        //[InlineData(Player.Black, "5e", "9a", TestName = "BeAbleToMoveFromCentreToTopLeftCornerAsBlackPlayer")]
        //[InlineData(Player.White, "5e", "1i", TestName = "BeAbleToMoveFromCentreToTopLeftCornerAsWhitePlayer")]
        //[InlineData(Player.Black, "5e", "1a", TestName = "BeAbleToMoveFromCentreToTopRightCornerAsBlackPlayer")]
        //[InlineData(Player.White, "5e", "9i", TestName = "BeAbleToMoveFromCentreToTopRightCornerAsWhitePlayer")]
        //[InlineData(Player.Black, "5e", "9i", TestName = "BeAbleToMoveFromCentreToBottomLeftCornerAsBlackPlayer")]
        //[InlineData(Player.White, "5e", "1a", TestName = "BeAbleToMoveFromCentreToBottomLeftCornerAsWhitePlayer")]
        //[InlineData(Player.Black, "5e", "1i", TestName = "BeAbleToMoveFromCentreToBottomRightCornerAsBlackPlayer")]
        //[InlineData(Player.White, "5e", "9a", TestName = "BeAbleToMoveFromCentreToBottomRightCornerAsWhitePlayer")]
